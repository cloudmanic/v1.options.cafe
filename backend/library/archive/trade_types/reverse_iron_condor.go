...
//
func GetReverseIronCondorRiskProfile(positions *[]models.Position) (float64, float64) {
...
//
// Detect if this trade is an Reverse Iron Condor
//
func IsReverseIronCondor(positions *[]models.Position) bool {
	...
	// Make sure this is not a regular iron condor
