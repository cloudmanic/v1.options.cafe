...
//
func (t *Base) GetOptionByExpirationDateAndStrike(expire time.Time, strike float64, optionType string, options []types.OptionsChainItem) types.OptionsChainItem {
