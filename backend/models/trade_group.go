...
type TradeGroup struct {
	...
	Type             string     `sql:"not null;type:ENUM('Option', 'Equity', 'Short Equity', 'Put Credit Spread', 'Call Credit Spread', 'Put Debit Spread', 'Call Debit Spread', 'Iron Condor', 'Reverse Iron Condor', 'Long Call Butterfly', 'Other'); default:'Other'" json:"type"`
