...
@Component({
  selector: 'app-trading-positions-types-iron-condor',
  templateUrl: './iron-condor.component.html',
  styleUrls: []
})

export class IronCondorComponent implements OnInit 
{
  @Input() quotes = {};
  @Input() orders: Order[];
  ...
  getTradeProfitLoss(tradeGroup: TradeGroup): number 
  {
    ...
    return tradeGroup.Credit - (close * -1);
  }
}
