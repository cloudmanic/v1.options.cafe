...
@Component({
  selector: 'app-trading-positions-long-put-butterfly',
  templateUrl: './long-put-butterfly.component.html',
  styleUrls: []
})

export class LongPutButterflyComponent implements OnInit 
{
  @Input() quotes = {};
  @Input() orders: Order[];
  @Input() title: string;
